...
CREATE TABLE `customer` (
  ...
  CONSTRAINT `fk_Customer_RoomRating` FOREIGN KEY (`RoomRating_RoomRatingID`) REFERENCES `roomrating` (`room_ratingId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `roomamenity` (
  ...
  CONSTRAINT `fk_Room_RoomID1` FOREIGN KEY (`roomamenity_roomId`) REFERENCES `room` (`roomId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `roomrating` (
  `room_ratingId` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rating` decimal(12,2) unsigned NOT NULL,
  `start_date` date NOT NULL,
  `end_date` date DEFAULT NULL,
  `rating_roomId` int(10) unsigned NOT NULL,
  PRIMARY KEY (`room_ratingId`),
  KEY `fk_Room_RoomID2` (`rating_roomId`),
  CONSTRAINT `fk_Room_RoomID2` FOREIGN KEY (`rating_roomId`) REFERENCES `room` (`roomId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `roomreservation` (
  ...
  KEY `fk_Customer_CustomerID` (`reservation_customerId`),
  KEY `fk_Room_RoomID` (`reservation_roomId`),
  CONSTRAINT `fk_Customer_CustomerID` FOREIGN KEY (`reservation_customerId`) REFERENCES `customer` (`customerId`),
  CONSTRAINT `fk_Room_RoomID` FOREIGN KEY (`reservation_roomId`) REFERENCES `room` (`roomId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-07-10 10:55:28

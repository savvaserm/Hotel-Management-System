...
INSERT INTO `hotel` VALUES (1,'MyHotel');
...
CREATE TABLE `room` (
  ...
  `RoomType_RoomTypeID` int(10) unsigned NOT NULL,
  `Hotel_HotelID` int(10) unsigned NOT NULL,
  PRIMARY KEY (`RoomID`),
  KEY `fk_RoomType_RoomTypeID` (`RoomType_RoomTypeID`),
  KEY `fk_Hotel_HotelID2` (`Hotel_HotelID`),
  CONSTRAINT `fk_Hotel_HotelID2` FOREIGN KEY (`Hotel_HotelID`) REFERENCES `hotel` (`HotelID`),
  CONSTRAINT `fk_RoomType_RoomTypeID` FOREIGN KEY (`RoomType_RoomTypeID`) REFERENCES `roomtype` (`RoomTypeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roomtype` VALUES (1,'Single room'),(2,'Double room'),(3,'Family room'),(4,'Suite');
...
-- Dump completed on 2019-07-05 15:40:02

...
public class WebConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers("/users/hotels/roomtypes", "/users/hotels", "/users/list", "/users/register", "/users/login", "/users/logout", "/users/create", "/users/profile", "/users/employees").permitAll()

...
public class WebConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers( "/users/hotels/rooms/rateroom", "/users/hotels/rooms/rating", "/users/hotels/reservations/cancel", "/users/hotels/reservations", "/users/hotels/rooms/amenities", "/users/hotels/reserveroom",

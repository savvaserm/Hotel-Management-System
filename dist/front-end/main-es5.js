...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.logIn(this.user)
            ...
            _this.successMessage = 'User logged in';
        }, function (err) {
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        this.accountService.createAccount(this.user).subscribe(function (data) {
            ...
            _this.errorMessage = 'The username you have entered already exists';
        });
    };
...
var AccountService = /** @class */ (function () {
    ...
    AccountService.prototype.createAccount = function (user) {
        return this.http.post(_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"].API_URL + '/users/register', user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (resp) { return console.log(resp); }));
    };

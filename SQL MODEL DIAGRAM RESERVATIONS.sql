...
CREATE TABLE IF NOT EXISTS `HotelReservation`.`roomamenity` (
  ...
  INDEX `fk_Amenity_AmenityID` (`roomamenity_amenityId` ASC) VISIBLE,
  CONSTRAINT `fk_Amenity_AmenityID`
    FOREIGN KEY (`roomamenity_amenityId`)
    REFERENCES `HotelReservation`.`amenity` (`amenityId`),
  CONSTRAINT `fk_amenity_roomId`
    FOREIGN KEY (`roomamenity_roomId`)

...
INSERT INTO `hibernate_sequence` VALUES (330),(330);
...
INSERT INTO `quantity` VALUES (1,11),(2,4),(3,6),(4,2);
...
CREATE TABLE `room` (
  ...
  `room_roomtypeId` int(11) DEFAULT NULL,
  PRIMARY KEY (`roomId`),
  KEY `fk_room_hotelid` (`room_hotelId`),
  KEY `fk_roomtypeId_idx` (`roomtypeId`),
  KEY `FKow8p8m32c6j6glne8bx2stx2n` (`room_roomtypeId`),
  CONSTRAINT `FKow8p8m32c6j6glne8bx2stx2n` FOREIGN KEY (`room_roomtypeId`) REFERENCES `roomtype` (`room_typeId`),
  CONSTRAINT `fk_room_hotelid` FOREIGN KEY (`room_hotelId`) REFERENCES `hotel` (`hotelId`),
  CONSTRAINT `fk_roomtypeId` FOREIGN KEY (`roomtypeId`) REFERENCES `roomtype` (`room_typeId`)
...
INSERT INTO `room` VALUES (1,'Room 100',1,1,0,1,NULL),(2,'Room 101',1,1,1,0,NULL),(3,'Room 102',1,2,0,1,NULL),(4,'Room 103',1,3,1,0,NULL),(5,'Room 104',1,3,1,1,NULL),(6,'Room 200',1,1,0,1,NULL),(7,'Room 201',1,1,0,1,NULL),(8,'Room 202',1,2,1,0,NULL),(9,'Room 203',1,3,1,0,NULL),(10,'Room 204',1,3,1,0,NULL),(11,'Room 300',1,1,0,1,NULL),(12,'Room 301',1,1,1,1,NULL),(13,'Room 302',1,3,1,0,NULL),(14,'Room 303',1,4,0,1,NULL),(15,'Room 304',1,4,1,0,NULL),(16,'Room 305',1,3,1,1,NULL),(17,'Room 306',1,2,1,1,NULL),(18,'Room 307',1,1,1,0,NULL),(19,'Room 308',1,2,1,0,NULL),(20,'Room 309',1,1,1,1,NULL);
...
INSERT INTO `roomrating` VALUES (295,3,'Good',1,4),(297,5,'Perfect',14,4),(299,2,'Not so good',3,5),(302,4,'very good',1,5),(327,3,'Metrio',2,4);
...
INSERT INTO `roomreservation` VALUES (288,2,'2019-08-08','2019-08-10',150.00,4,'Your ID is: 4',NULL),(289,2,'2019-11-14','2019-11-14',60.00,4,'Your ID is: 4',NULL),(290,14,'2019-10-10','2019-10-26',3845.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 14, Room 303 ] , customer: Ermidis, checkin: 2019-10-10, reserved for 16 nights, total price: 3845.0 $, \nRefund if cancelled: true',NULL),(291,3,'2019-10-10','2019-10-26',1836.00,5,'Your ID is: 5\nHotel: Hotel 1, room id and room number: [ 3, Room 102 ], customer: Messi, checkin: 2019-10-10, reserved for 16 nights, total price: 1836.0 $, \nRefund if cancelled: true',NULL),(294,3,'2019-10-27','2019-10-27',128.00,6,'Your ID is: 6\nHotel: Hotel 1, room id and room number: [ 3, Room 102 ], customer: Rmds, checkin: 2019-10-27, reserved for 0 nights, total price: 128.0 $, \nRefund if cancelled: true',NULL),(315,6,'2019-10-07','2019-10-08',102.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 6, Room 200 ] , customer: Ermidis, checkin: 2019-10-07, reserved for 1 nights, total price: 102.0 $, \nRefund if cancelled: true',NULL),(316,7,'2019-10-07','2019-10-08',102.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 7, Room 201 ] , customer: Ermidis, checkin: 2019-10-07, reserved for 1 nights, total price: 102.0 $, \nRefund if cancelled: true',NULL),(318,11,'2019-10-07','2019-10-08',102.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 11, Room 300 ] , customer: Ermidis, checkin: 2019-10-07, reserved for 1 nights, total price: 102.0 $, \nRefund if cancelled: true',NULL),(319,1,'2019-10-07','2019-10-08',102.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 1, Room 100 ] , customer: Ermidis, checkin: 2019-10-07, reserved for 1 nights, total price: 102.0 $, \nRefund if cancelled: true',NULL),(320,2,'2019-10-07','2019-10-08',92.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 2, Room 101 ] , customer: Ermidis, checkin: 2019-10-07, reserved for 1 nights, total price: 92.0 $, \nRefund if cancelled: false',NULL),(323,1,'2019-10-09','2019-10-09',51.00,4,'Your ID is: 4\nHotel: Hotel 1, room id and room number: [ 1, Room 100 ] , customer: Ermidis, checkin: 2019-10-09, reserved for 0 nights, total price: 51.0 $, \nRefund if cancelled: true',NULL);
...
-- Dump completed on 2019-08-27 15:45:51
